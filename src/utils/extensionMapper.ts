...
const extensionToTypeMapper = new Map<string, string>(
  Object.entries(fileExtensions),
); // txt => Unformatted text file, html => Hypertext Markup Language page

/**
 * This functions takes a file extension and yeelds the corresponding file type according to the hash map above
 * @param extension the file extension
 * @returns the extended type
 */
export function getType(extension: string): string {
  return (
    extensionToTypeMapper.get(extension) || `${extension.toUpperCase()} file`
  );
}
